    ...
    return (
        <div>
              <div className='w-fit flex gap-2 items-center mx-auto my-0 mt-2 px-1.5 py-1'>
                <button className='min-w-26 bg-gradient-to-br from-slate-400 to-slate-700 px-6 py-1.5 text-sm text-white rounded-full cursor-pointer prev scale-90'>Previous</button>
                ...
                <button className='min-w-26 bg-gradient-to-br from-slate-400 to-slate-700 px-6 py-1.5 text-sm text-white rounded-full cursor-pointer nxt scale-90'>Next</button>
              </div>
            </div>
    );
}
